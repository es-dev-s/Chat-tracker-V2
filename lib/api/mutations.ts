...
/** Background version/full sync — avoids blocking UI after record writes. */
function scheduleWorkspaceRefresh(forceFull = false): void {
  requestWorkspaceSync(forceFull);
}
